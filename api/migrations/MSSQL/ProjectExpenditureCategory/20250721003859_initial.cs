...
namespace budget_request_app.WebApi.Migrations.MSSQL.ProjectExpenditureCategory
{
    /// <inheritdoc />
    public partial class initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "ProjectExpenditureCategories",
                schema: "lookup",
                columns: table => new
                {
                    ...
                    ShortDisplayName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProjectExpenditureCategories", x => x.Id);
                });
        }
