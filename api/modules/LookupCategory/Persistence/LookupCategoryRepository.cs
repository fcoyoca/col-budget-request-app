...
internal sealed class LookupCategoryRepository<T> : RepositoryBase<T>, IReadRepository<T>, IRepository<T>
    where T : class, IAggregateRoot
{
    public LookupCategoryRepository(LookupCategoryDbContext context)
        : base(context)
    {
    }
