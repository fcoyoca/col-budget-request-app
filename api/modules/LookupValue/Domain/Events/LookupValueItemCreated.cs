...
public record LookupValueItemCreated(Guid Id, string name, Guid? lookupCategoryId) : DomainEvent;
    ...
    : INotificationHandler<LookupValueItemCreated>
{
    public async Task Handle(LookupValueItemCreated notification, CancellationToken cancellationToken)
    {
        ...
        var cacheResponse = new GetLookupValueResponse(notification.Id, notification.name, notification.lookupCategoryId);
